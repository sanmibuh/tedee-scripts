...
## ⏰ Crontab Scheduling (Main Use Case)
...
| What | Where |
|------|-------|
| Your config | `config/tedee.conf` |
| Config template | `config/tedee.conf.template` |
...
- Make sure `config/tedee.conf` exists
- Copy from template: `cp config/tedee.conf.template config/tedee.conf`
- Run setup: `./setup.sh`
